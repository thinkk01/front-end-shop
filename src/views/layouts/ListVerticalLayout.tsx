...
import { Collapse, ListItemButton, ListItemText, ListSubheader, ListItemIcon, styled, Tooltip, List } from "@mui/material";
              ...
              <List component="div" disablePadding>
                ...
                const isActive = activePath === child.path;
                  ...
                  <ListItemButton sx={{
                    ...
                    <ListItemIcon color={isActive ? "white" : undefined}><IconifyIcon icon={child.icon} width="24" height="24" /></ListItemIcon>
                    <Tooltip title={child.title}><StyleListItemText primary={child.title} /></Tooltip>
                  </ListItemButton>
                );
                }
                )}
